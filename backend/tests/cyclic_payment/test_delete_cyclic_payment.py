...
@patch('cyclic_payments.cyclic_payment_repository.CyclicPaymentRepository.find_by_id')
@patch('accounts.account_repository.AccountRepository.find_by_id')
def test_delete_cyclic_payment_unauthorised(mock_account, mock_cp, client, test_user, test_cyclic_payment, test_unauthorised_account):
    with patch('flask_login.utils._get_user', return_value=test_user):
        mock_cp.return_value = test_cyclic_payment
...
def test_delete_cyclic_payment_success(mock_delete, mock_update, mock_account, mock_cp, client, test_user, test_cyclic_payment, test_account):
    with patch('flask_login.utils._get_user', return_value=test_user):
        mock_cp.return_value = test_cyclic_payment
