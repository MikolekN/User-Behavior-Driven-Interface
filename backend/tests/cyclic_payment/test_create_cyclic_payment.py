...
from tests.cyclic_payment.constants import TEST_NOT_ENOUGH_USER_FUNDS
...
def test_create_cyclic_payment_missing_data(client, test_user):
    with patch('flask_login.utils._get_user', return_value=test_user):
        ...
        assert_json_response(response, HTTPStatus.BAD_REQUEST,
                             'missingFields;recipient_account_number,cyclic_payment_name,transfer_title,amount,start_date,interval')

        response = client.post('/api/cyclic-payment', json={'recipient_account_number': ""})
        assert_json_response(response, HTTPStatus.BAD_REQUEST,
                             'missingFields;cyclic_payment_name,transfer_title,amount,start_date,interval')
        ...
        assert_json_response(response, HTTPStatus.BAD_REQUEST,
                             'missingFields;transfer_title,amount,start_date,interval')
...
def test_create_cyclic_payment_invalid_data(client, test_user):
    with patch('flask_login.utils._get_user', return_value=test_user):
        ...
        assert_json_response(response, HTTPStatus.BAD_REQUEST,
                             'invalidTypeFields;recipient_account_number,cyclic_payment_name,transfer_title,amount,start_date,interval')
...
def test_create_cyclic_payment_empty_field_data(client, test_user):
    with patch('flask_login.utils._get_user', return_value=test_user):
        ...
        assert_json_response(response, HTTPStatus.BAD_REQUEST,
                             'emptyFields;recipient_account_number,cyclic_payment_name,transfer_title,start_date,interval')
...
def test_create_cyclic_payment_recipient_account_not_enough_money(mock_another_account, mock_account, mock_user, client,
...
def test_create_cyclic_payment_successful(mock_insert, mock_update, mock_another_account, mock_account, mock_user,
                                          client, test_user, test_cyclic_payment, test_account):
    with patch('flask_login.utils._get_user', return_value=test_user):
        mock_user.return_value = test_user
        mock_account.return_value = test_account
        mock_another_account.return_value = test_account
