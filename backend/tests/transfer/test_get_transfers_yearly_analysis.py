...
def test_get_transfers_yearly_analysis_not_exist(mock_account, mock_user, mock_find_transfers, client, test_user,
                                                 test_account):
    with patch('flask_login.utils._get_user', return_value=test_user):
...
@patch('users.user_repository.UserRepository.find_by_id')
@patch('accounts.account_repository.AccountRepository.find_by_id')
def test_get_transfers_yearly_analysis_success(mock_account, mock_user, mock_find_transfers, client, test_user,
                                               test_transfers, test_account):
    with patch('flask_login.utils._get_user', return_value=test_user):
