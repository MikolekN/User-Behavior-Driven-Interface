...
import application
from tests.constants import TEST_USER_LOGIN, TEST_USER_EMAIL, TEST_USER_ID, TEST_DIFFERENT_USER_ID, TEST_USER_PASSWORD, \
    TEST_ACCOUNT_NAME, TEST_ACCOUNT_CURRENCY, TEST_ACCOUNT_TYPE, TEST_USER_ICON
