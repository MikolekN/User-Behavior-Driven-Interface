...
@patch('users.user_repository.UserRepository.find_by_id', return_value=MagicMock(user_icon=None))
...
@patch('users.user_repository.UserRepository.find_by_id', return_value=MagicMock(user_icon="/path/to/nonexistent/icon.png"))
...
@patch('users.user_repository.UserRepository.find_by_id', return_value=MagicMock(user_icon="/path/to/existing/icon.png"))
