...
from routes.cyclic_payment.get_users_cyclic_payments import get_all_user_cyclic_payment
...
cyclic_payment_blueprint.add_url_rule('/cyclic-payments', 'get_all_user_cyclic_payment', get_all_user_cyclic_payment, methods=['GET'])
