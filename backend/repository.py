...
class BaseRepository:
    ...
    def find_by_id(self, entity_id: str, entity_class: Type[T]) -> T | None:
        return self.find_by_field('_id', ObjectId(entity_id), entity_class)

    def find_by_field(self, field: str, value: Any, entity_class: Type[T]) -> T | None:
        query = {field: value}
    ...
    def find_many(self, entity_class: Type[T], query: dict, sort_criteria: list[tuple[str, int]] = None) -> list[T] | None:
    ...
    def insert(self, entity: T) -> T:
        ...
        inserted_entity = self.find_by_id(str(result.inserted_id), entity.__class__)
    ...
    def update(self, entity_id: str, updates: dict[str, any], entity_class: Type[T]) -> T | None:
        ...
        if result.matched_count == 0:
            return None
        return self.find_by_id(entity_id, entity_class)
