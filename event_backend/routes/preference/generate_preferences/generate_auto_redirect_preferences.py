...
from page_transition_event.constants import AUTO_REDIRECT_TIME_SPENT_THRESHOLD, DEFAULT_AUTO_REDIRECT_URL, FORM_SUBMIT_CLICK_EVENT_ELEMENT_IDS
...
def generate_auto_redirect_preferences(user_id: str) -> dict:
    ...
    for element_id in FORM_SUBMIT_CLICK_EVENT_ELEMENT_IDS:
        ...
        for e in form_submit_click_events:
            page_transition_event_after_form_submit = page_transition_event_repository.get_second_page_transition_event_after_form_submit(user_id, e.start_timestamp)
