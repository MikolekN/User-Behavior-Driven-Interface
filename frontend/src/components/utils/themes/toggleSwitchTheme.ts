import { FlowbiteToggleSwitchTheme } from "flowbite-react";
...
export const toggleSwitchTheme: FlowbiteToggleSwitchTheme = {
  "root": {
    ...
    "label": "ms-3 mt-0.5 text-start text-sm font-medium text-gray-900 dark:text-gray-400",
  },
  "toggle": {
    ...
    "checked": {
      ...
      "off": "bg-gray-200 after:border-gray-300 dark:bg-slate-500",
      "color": {
        "default": "bg-blue-700 group-focus:ring-primary-300 dark:group-focus:ring-primary-800",
        "blue": "bg-blue-700 group-focus:ring-blue-300 dark:group-focus:ring-slate-800 dark:bg-slate-900 dark:focus:ring-slate-700",
